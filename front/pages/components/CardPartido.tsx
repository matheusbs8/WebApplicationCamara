...
export default function CardPartido({Logo, NomePartido, Sigla, idPartido}:Partido){
    ...
    return(
    <div className="bg-gray-900 w-[30rem] h-52 text-red-50 ml-10 mt-10 mr-10 flex flex-col items-center rounded-2xl"  onClick={()=>{router.push(`/telas/DeputadosPartido/${idPartido}`)}}>
